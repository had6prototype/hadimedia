        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>فایل ویدیوی برنامه را آپلود کنید (حداکثر 50 مگابایت) - آپلود مستقیم</CardDescription>
            </CardHeader>
            <CardContent>
              {formData.videoUrl ? (
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-green-600">✅ آپلود مستقیم به Supabase (سریع و قابل اعتماد)</p>
                  </div>
                  <div className="mt-4">
                    <input
                      type="file"
                  ...
                  {isVideoUploading && (
                    <div className="mt-4">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">آپلود مستقیم در حال انجام...</p>
                    </div>
                  )}
                </div>
              )}
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>تصویر نمایشی برنامه (حداکثر 5 مگابایت) - آپلود مستقیم</CardDescription>
            </CardHeader>
            <CardContent>
