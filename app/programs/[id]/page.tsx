      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="space-y-4">
            ...
            {/* Description */}
            <div className="space-y-4">
              <h2 className="text-lg font-semibold">درباره این برنامه</h2>
              <p className="text-muted-foreground whitespace-pre-line leading-relaxed">{program.description}</p>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-8">
            <h2 className="text-lg font-semibold mb-4">برنامه‌های مرتبط</h2>
                    ...
                    <div className="flex gap-3 p-2 rounded-lg hover:bg-muted transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-1 text-xs text-muted-foreground">
                          ...
                          <span>•</span>
                          <span>{new Date(relatedProgram.created_at).toLocaleDateString("fa-IR")}</span>
                        </div>
