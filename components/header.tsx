      ...
      <div className="container flex h-20 items-center">
        <div className="flex items-center justify-between w-full">
          ...
          <nav className="hidden md:flex items-center space-x-6 space-x-reverse">
            ...
            <Link
              href="/admin"
              className="text-sm font-medium hover:text-primary bg-primary/10 px-3 py-1 rounded-md text-primary"
            >
              پنل مدیریت
            </Link>
          </nav>
      ...
      >
        <div className="relative z-20 grid gap-6 p-4 rounded-md bg-background">
          ...
          <nav className="grid grid-flow-row auto-rows-max text-sm">
            ...
            <Link
              href="/admin"
              className="flex w-full items-center rounded-md p-2 hover:bg-muted bg-primary/10 text-primary mb-2"
              onClick={() => setIsMenuOpen(false)}
            >
              پنل مدیریت
            </Link>
