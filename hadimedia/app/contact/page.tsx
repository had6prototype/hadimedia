      ...
      <div className="grid gap-8 md:grid-cols-3 mb-12">
        ...
        <Card className="text-center">
          ...
          <CardContent>
            ...
            <p className="font-medium">info@alhadi.co.uk</p>
        ...
        <Card className="text-center">
          ...
          <CardContent>
            ...
            <p className="font-medium">لندن، انگلستان</p>
        ...
        <div className="lg:col-span-2">
          <Tabs defaultValue="faq" className="h-full">
            ...
            <TabsContent value="social" className="border rounded-md mt-2 p-4 h-[calc(100%-40px)]">
              ...
              <div className="space-y-4">
                <a
                  href="https://www.facebook.com/fd.haditv6/photos_by"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/fd_haditv6"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-3 border rounded-md hover:bg-muted/50 transition-colors"
                >
